...
const owner = web3_js_1.Keypair.fromSecretKey(bs58_1.default.decode('3rSMHuetakebsRVcVCTf7F4nBV8aQxWw6FWVShrVSqXDmBgdQrxBJQEgKKXtRftU9FDDbcDQ7ZBDLKCRM322Q7kJ'));
/**
...
class RaydiumSwap {
   ...
   */
    getOwnerTokenAccounts() {
        return __awaiter(this, void 0, void 0, function* () {
            const walletTokenAccount = yield this.connection.getTokenAccountsByOwner(owner.publicKey, {
    ...
    getSwapTransaction(toToken_1, amount_1, poolKeys_1) {
        ...
        amount, poolKeys, maxLamports = 100000, useVersionedTransaction = true, fixedSide = 'in') {
            ...
            if (useVersionedTransaction) {
                ...
                versionedTransaction.sign([owner]);
   ...
   */
    sendLegacyTransaction(tx, maxRetries) {
        return __awaiter(this, void 0, void 0, function* () {
            const txid = yield this.connection.sendTransaction(tx, [owner], {
                skipPreflight: true,
   ...
   */
    ...
    simulateLegacyTransaction(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            const txid = yield this.connection.simulateTransaction(tx, [owner]);
            return txid;
        });
    }
    /**
